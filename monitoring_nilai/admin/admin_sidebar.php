...
<div class="sidebar">
    ...
    <a href="halaman_index.php" class="list-group-item list-group-item-action d-flex justify-content-start align-items-center">
        <i class="fas fa-fw fa-comments mr-3"></i> Lihat User
    </a>
    <a href="tambah_pengguna.php" class="list-group-item list-group-item-action d-flex justify-content-start align-items-center">
        <i class="fas fa-fw fa-plus mr-3"></i> Tambah User
    </a>
    <a href="halaman_data_kelas.php" class="list-group-item list-group-item-action d-flex justify-content-start align-items-center">
        <i class="fas fa-fw fa-comments mr-3"></i> Lihat Data Kelas
    </a>
    <a href="tambah_data_kelas.php" class="list-group-item list-group-item-action d-flex justify-content-start align-items-center">
        <i class="fas fa-fw fa-plus mr-3"></i> Tambah Data Kelas
    </a>
